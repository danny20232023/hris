 ...
 */
export const formatEmployeeName = (surname, firstname, middlename = null, extension = null) => {
 ...
 * @returns {string} - Formatted name in "Last Name, First Name Middle Name" format with Title Case
 */
export const formatEmployeeNameFromString = (fullNameString, format = 'auto') => {
...
/**
 * Intelligently formats employee name from an object with various structures
 * Handles objects with individual fields, pre-formatted names, or mixed formats
 * @param {object} employee - Employee object with name information
 * @returns {string} - Formatted name in "Last Name, First Name Middle Name" format with Title Case
 */
export const formatEmployeeNameFromObject = (employee) => {
  if (!employee || typeof employee !== 'object') {
    return '';
  }
  
  // Try individual fields first (most reliable)
  if (employee.surname || employee.firstname || employee.middlename) {
  ...
  for (const field of nameFields) {
    if (employee[field] && typeof employee[field] === 'string') {
      return formatEmployeeNameFromString(employee[field]);
    }
  }
  
  // Try lastname/firstname variations
